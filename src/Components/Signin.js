    ...
    return (
      ...
      <div className="main-container">
        <div className="container-fluid col-lg-4 offset-lg-4">
          <div className="row">
          <a className="col-lg-8 offset-lg-2 col-sm-4 col-md-4 offset-md-4" href='./'>
          <img src='https://cdn.shopify.com/s/files/1/0068/2302/t/185/assets/deny_designs_logo.svg?v=2968452402992386186'></img>
          </a>
          </div>
